...
const apiService = {
  ...
  adminVerifyProvider: (id) => apiClient.patch(`/admin/providers/${id}/verify`),
  adminRejectProvider: (id, reason) => apiClient.patch(`/admin/providers/${id}/reject`, { reason }),
  ...
  // Disputes
  reportDispute: (data) => apiClient.post('/disputes/report', data),
  getAdminDisputes: () => apiClient.get('/admin/disputes'),
  resolveDispute: (id, data) => apiClient.post(`/admin/disputes/${id}/resolve`, data),
  rejectDispute: (id, data) => apiClient.post(`/admin/disputes/${id}/reject`, data),
